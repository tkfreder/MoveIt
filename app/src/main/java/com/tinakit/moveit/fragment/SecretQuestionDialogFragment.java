...
/**
 * Created by Tina on 2/22/2016.
 */
public class SecretQuestionDialogFragment extends DialogFragment {
    ...
    SecretQuestionListener mListener;
    ...
    public void onAttach(Activity activity) {
        ...
        try {
            ...
            mListener = (SecretQuestionListener) activity;
                ...
                .setPositiveButton(R.string.button_signin, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        if (isValidAdmin){
                            ...
                            mListener.onAdminLoginDialogPositiveClick(SecretQuestionDialogFragment.this);
                        }
                        else {

                            // treating this as a flag indicating validation of sign in failed
                            mListener.onAdminLoginDialogNegativeClick(SecretQuestionDialogFragment.this);
                        }
                    }
                });
